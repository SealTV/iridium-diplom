namespace Iridium.Utils
{
    ...
    public class Periodic
    {
        ...
        private System.Threading.Timer threadtimeTimer;
        public Periodic(Action action, long timeInterval)
        {
            this.action = action;
            ...
            this.threadtimeTimer = new System.Threading.Timer(Run, null, 0, timeInterval);
        }
        ...
        public static class PeriodicTaskFactory
        {
                                     ...
                                     TaskCreationOptions periodicTaskCreationOptions = TaskCreationOptions.None)
            {
                ...
                Action mainAction = () =>
                                    {
                                        MainPeriodicTaskAction(intervalInMilliseconds, delayInMilliseconds, duration,
                                                               maxIterations, cancelToken, stopWatch, synchronous,
                                                               wrapperAction, periodicTaskCreationOptions);
                                    };
            ...
            {
                TaskCreationOptions subTaskCreationOptions = TaskCreationOptions.AttachedToParent |
                ...
                using (ManualResetEventSlim periodResetEvent = new ManualResetEventSlim(false))
                {
                    ...
                    while (true)
                    {
                        ...
                        Task subTask = Task.Factory.StartNew(wrapperAction, cancelToken, subTaskCreationOptions,
                                                             TaskScheduler.Current);
