namespace Assets.Scripts
{
    ...
    public class ServerConnector:MonoBehaviour,IServerConnector
    {
        ...
        public void GetLevelData(int gameId, int levelId)
        {
            ...
            using (StreamReader sr = new StreamReader("C:\\first_level.json"))
            {
                String line;
            ...
            var pak2 = new PacketsFromMaster.LevelData(pak.GameId, pak.LevelId, allines);
            GlobalData.LevelData = pak2;
        }
